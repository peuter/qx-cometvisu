 ...
 */
qx.Mixin.define("cv.mixin.MExcluded",
{
  /*
   *****************************************************************************
      PROPERTIES
  ...
  properties : {
    ...
    /**
     * Allows excluding widgets by appearance
     */
    excluded : {
      init : false,
      check : "Boolean",
      themeable : true,
      apply : "_applyExcluded"
    }
  },
  ...
  */
  ...
  {
    //property apply
    _applyExcluded : function(value) {
      this.setVisibility(value === true ? "excluded" : "visible");
    }
  }
});
